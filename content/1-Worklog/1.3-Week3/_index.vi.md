...
|:---:|---|:---:|:---:|---|
| 2 | - Tạo tài khoản AWS<br>&emsp;+ Thực hiện đăng ký, xác minh danh tính, thêm phương thức thanh toán và chọn gói hỗ trợ.<br>&emsp;+ Bật MFA và hạn chế sử dụng tài khoản root cho công việc hằng ngày.<br>- Tạo người dùng IAM<br>&emsp;+ Tạo IAM User, thiết lập thông tin đăng nhập và cấp quyền phù hợp.<br>&emsp;+ Sử dụng IAM User thay cho root user để tăng tính bảo mật.<br>- Lựa chọn AWS Region<br>&emsp;+ Biết cách thay đổi Region trên AWS Management Console.<br>&emsp;+ Hiểu rằng tài nguyên, giá dịch vụ và độ trễ có thể khác nhau giữa các Region.<br>- Quản lý chi phí AWS<br>&emsp;+ Tìm hiểu các nguyên nhân gây phát sinh chi phí ngoài dự kiến.<br>&emsp;+ Biết cách kiểm tra, dừng và xóa tài nguyên không còn sử dụng.<br>- AWS Budgets, Free Tier và Billing Alarm<br>&emsp;+ Tạo ngân sách và cảnh báo khi chi phí đạt ngưỡng.<br>&emsp;+ Hiểu giới hạn của AWS Free Tier và cách theo dõi chi phí bằng CloudWatch, SNS. | 20/07/2026 | 20/07/2026 | [AWS Certified Cloud Practitioner (CLF C02)](https://www.youtube.com/playlist?list=PLBfufR7vyJJ4du5ANexy0SuQ0J7KhRcjI) |
...
&emsp;◉ Thứ 2:
<br>&emsp;&emsp;○ Tạo và kích hoạt được tài khoản AWS.
<br>&emsp;&emsp;○ Tạo được IAM User có quyền truy cập riêng.
<br>&emsp;&emsp;○ Biết lựa chọn Region phù hợp trước khi tạo tài nguyên.
<br>&emsp;&emsp;○ Hiểu cách sử dụng AWS Free Tier an toàn.
<br>&emsp;&emsp;○ Biết thiết lập ngân sách và cảnh báo chi phí.
<br>&emsp;&emsp;○ Có thể kiểm tra, dừng hoặc xóa tài nguyên để tránh phát sinh phí ngoài ý muốn.

&emsp;◉ Thứ 5:
<br>&emsp;&emsp;○ Hiểu vai trò của Cloud trong đổi mới và chuyển đổi số.
<br>&emsp;&emsp;○ Phân biệt được CPU, GPU và các dịch vụ tính toán chuyên dụng của AWS.
