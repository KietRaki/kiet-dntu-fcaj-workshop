...
| 3 | - Làm công việc được giao cho dự án<br>&emsp;+ Import database bookstoredb.sql:<br>&emsp;&emsp;++ Tạo EC2 tạm thời RakiBookery-rds-import để làm máy trung gian.<br>&emsp;&emsp;++ Kết nối SSH từ Windows đến EC2.<br>&emsp;&emsp;++ Cài MySQL client.<br>&emsp;&emsp;++ Đưa file bookstoredb.sql lên EC2 và import vào RDS.<br>&emsp;+ Kiểm tra database sau khi import:<br>&emsp;&emsp;++ Xác nhận database bookstoredb tồn tại.<br>&emsp;&emsp;++ Kiểm tra dữ liệu có đầy đủ không.<br>&emsp;&emsp;++ Kiểm tra kết nối EC2 tới RDS bằng TCP port 3306.<br>&emsp;+ Chuẩn bị cho kết nối Fargate:<br>&emsp;&emsp;++ Xác định RDS sẽ cho phép Fargate Security Group truy cập port 3306.<br>&emsp;&emsp;++ Chưa kiểm tra được Fargate tới RDS vì Fargate Cluster chưa được tạo.<br>&emsp;&emsp;++ Sẽ thực hiện kiểm tra sau khi thành viên phụ trách ECS hoàn thành tạo Cluster. | 22/09/2026 | 22/09/2026 |  |
